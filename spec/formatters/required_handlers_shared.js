...
const events = ['fileStart', 'fileEnd', 'contextStart', 'contextEnd', 'exampleStart', 'exampleEnd', 'contextLevelFailure', 'runEnd'];

module.exports = () =>
  sharedContext('event handlers defined', FormatterClass => {
    ...
    describe('defined handlers', () => {
      ...
      it('#contextLevelFailure', () => expect(() => withoutStdOut(() => formatter.contextLevelFailure(null, runnable))).not.to.throw());
